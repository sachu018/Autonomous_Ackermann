...
MAX_LINEAR_SPEED = 0.15  # Capped at 20% of physical maximum (0.366 m/s)
...
def main():
    ...
    # Initialize P loops for linear and angular velocities (Proportional-only)
    # Kp_rho = 0.8, Ki_rho = 0.0, Kd_rho = 0.0
    # Kp_alpha = 1.5, Ki_alpha = 0.0, Kd_alpha = 0.0
    pid_v = PIDController(Kp=0.8, Ki=0.0, Kd=0.0, max_output=MAX_LINEAR_SPEED, min_output=-MAX_LINEAR_SPEED)
    pid_w = PIDController(Kp=2.0, Ki=0.0, Kd=0.0, max_output=2.0, min_output=-2.0)
