...
class BBBHardware:
    ...
    def drive_motors(self, rpm_L, rpm_R, enc_l=None, enc_r=None, dt=0.05):
        ...
        # Check if direction is switching on either motor
        if new_rev_L != self.current_rev_L or new_rev_R != self.current_rev_R:
            ...
            # Reset speed controller integrals to prevent surge
...
# ==========================================
def main():
    csv_path = "/home/debian/Robot/circle_waypoints_r3.0m_20260630_195134.csv"
    ...
    # Initialize IMU Dead Reckoning (Inertial Navigation)
    x_imu, y_imu = waypoints[0]
